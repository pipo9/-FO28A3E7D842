...
class _OrderDtailsState extends State<OrderDtails> {
  ...
  int status = 0;
  List<Color> bgColors = [kBlueAccent.withOpacity(0.2), kColor, kGreen];
  List<Color> iconsColors = [kColor, klightGrey, klightGrey];
  List<String> statusString = ['Prepared','processing','delivered'];
  List<IconData> icons = [Icons.pending_actions,Icons.loop,Icons.local_mall];
